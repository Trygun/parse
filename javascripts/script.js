jQuery(document).ready(function($) {
	$('.gal-carusel-foto').jCarouselLite({
		circular: false,
		scroll: 2,
		visible: 4,
		speed: 1500,
	...
	$('.gal-carusel-news').jCarouselLite({
		circular: false,
		scroll: 2,
		visible: 4,
		speed: 1500,
	...
	$('.gal-carusel-hits').jCarouselLite({
		circular: false,
		scroll: 2,
		visible: 4,
		speed: 1500,
	...
	$('.smyCarousel').carousel({
		  interval: 2000,
		  pause: "hover",
		  wrap: true
	});	  
		$('#red-selection').hover(function()
		{
			$('#red-selection-full').show();
		}); 
		$('#red-selection-full').hover(function(){
			$('#red-selection-full').show();}
			,function(){
				$('#red-selection-full').hide()});
				
		$('#serch-small').click(function()
		{
			$('#search').show();
			$('#search-inpt').focus();
			$('#serch-small').hide();
	...
	function go_to(item) {
		$(item).scroll_to_anchor();
   }
/*
	Ввел этот код в тестовое задание для того, чтобы включить
	возможность использования checkbox-ов в стандартном выпадающем
	меню bootstrap. Лицензия данного ПО свободная, но требует указания источника.
*/
/* ========================================================================
